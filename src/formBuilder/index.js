...
import {View, Keyboard, Text, KeyboardAvoidingView} from 'react-native';
    ...
    validate(callback) {
        if (this.props.customValidation
            ...
            Object.keys(this.state).forEach((fieldName) => {
                ...
                if (field.name) {
                    let value = Object.assign({}, field, autoValidate(field));
                    ...
                    value = Object.assign({}, field, this.props.customValidation(field));
                    if (value.error) {
                        error = true;
                    }
                    values[field.name] = value;
    ...
    render() {
        return (
            <KeyboardAvoidingView
                ...
                behavior={'padding'}
                style={[{backgroundColor: 'transparent'}, this.props.keyboardStyle || {}]}
            >
                <View>
